...
/*Muestra las competiciones celebradas en Estados Unidos*/
SELECT nombre, fecha_inicio, fecha_fin, ubicacion FROM competicion WHERE codpais = 'USA';


/*Muestra los eventos(pruebas realizadas) en la competición del año 2023, junto
...
/*Cuántas atletas hay de cada país. Quédate sólo con los países que tienes dos
...
GROUP BY n.nombre_pais, n.codpais
HAVING COUNT(a.id) >= 2
ORDER BY cantidad_atletas DESC;

/*Muestra para cada carrera de los mundiales del 2023 el mejor tiempo y el peor tiempo*/
...
/*Mostrar los nombres de las carreras femeninas de menos de 600 metros. */
SELECT nombre
FROM disciplinas
